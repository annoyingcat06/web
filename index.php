...
<body>
    <header>
        ...
        <div class="icons">
            ...
            <?php if ($loggedIn): ?>
                <div class="dropdown">
                    <button class="dropbtn">User Account (<?php echo $_SESSION['email']; ?>)</button>
        ...
        <?php else: ?>
            <div id="login-form-container" class="login-form-container">
                ...
                <form method="post" action="login.php" id="loginForm">
                    ...
                    <input type="submit" value="Login Now" class="btn" name="login" id="loginBtn">
                    <p>Forgot password? <a href="#">Click here</a></p>
                    <p>Don't have an account? <a href="#" onclick="openRegisterForm()">Register now</a></p>
                </form>
            </div>

            <div id="registerformcontainer" class="registerformcontainer">
        ...
        <div class="content">
            ...
            <div class="social-media">
                ...
                <ul>
                    ...
                    <li><a href="https://linkedin.com/in/" target="_blank"><i class="fab fa-linkedin"></i>
                        </a></li>
                </ul>
            </div>
        </div>
